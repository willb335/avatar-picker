describe("The selected avatar moves to front of array", () => {
  ...
  it("moves to front of array when given an index of 1(first selectable index)", () => {
    list.unshift(list.splice(1, 1)[0]);
    expect(list).toEqual([1, 0, 2, 3, 4, 5]);
  });

  it("moves to front of array when given an index of 5(last selectable index)", () => {
    list.unshift(list.splice(5, 1)[0]);
    expect(list).toEqual([5, 1, 0, 2, 3, 4]);
  });

  it("moves to front of array when given a middle index", () => {
